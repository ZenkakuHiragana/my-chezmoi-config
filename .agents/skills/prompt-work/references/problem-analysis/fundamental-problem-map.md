...
| P4 認識の自己申告不能性 | モデルは、判断に必要な知識の不足と、知識・推論・補完の境界を安定して認識できず、現実に基づく問題像の形成と更新を誤る。 | 自己申告だけを根拠にせず、判断に必要な仕様・意味と反証材料へ接続し、問題像を実態との衝突によって更新できる経路を残す。 |
| P5 蓄積の不在           | セッション内の経験は、そのままでは再利用可能な知見・根拠・検証手段として残らない。                                     | 経験からそれらを抽出し、意味と根拠を保ってセッション外へ保存する。                                                     |
