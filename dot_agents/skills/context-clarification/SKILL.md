...
| ID  | 明示要求の逐語引用または認可元 | 必要な結果 | 対象範囲 | 保つ条件 | 結果を生む実経路 | 観測する結果と確認主体・ツール・環境 | 利用者または情報所有先 |
| --- | ------------------------------ | ---------- | -------- | -------- | ---------------- | ------------------------------------ | ---------------------- |
...
- `判断と認可`表の全判断に認可元がある。
- 各意味上の義務に、必要な結果、対象範囲、保つ条件、実経路、観測する結果、確認主体、利用者または情報所有先が対応している。
