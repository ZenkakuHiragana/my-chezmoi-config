...
最終成果物とは、意図した読者が後で読む文章である。例として、README、仕様、運用ガイド、設計メモ、コードコメント、プロンプト本文、スキル本文、リリースノート、会話から作った再利用可能な下書き、通常の文書節がある。
...
README、仕様、通常の文書、コードコメント、プロンプト本文、スキル本文などの規範的な成果物では、次だけを残す。
